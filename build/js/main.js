...
// sound init
var backgroundMusic = new _howler.Howl({
  src: ['main-music.mp3'],
  volume: 1.0,
  loop: true
});
var reelSound = new _howler.Howl({
  src: ['reels.mp3'],
  volume: 1.0,
  loop: true
});
var winSlots = new _howler.Howl({
  src: ['win-slots.mp3'],
  volume: 1.0,
  loop: false
});
...
var slotSound = new _howler.Howl({
  src: ['line.mp3'],
  volume: 1.0,
  loop: false
});
...
(function startSlotsImg() {
  var startCol1 = ['win5.png', 'win6.png', 'win3.png', 'win5.png', 'win3.png'];
  var startCol2 = ['win6.png', 'win6.png', 'win8.png', 'win5.png', 'win6.png'];
  var startCol3 = ['win4.png', 'win8.png', 'win4.png', 'win7.png', 'win8.png'];
  var startCol4 = ['win5.png', 'win8.png', 'win6.png', 'win7.png', 'win8.png'];
  var startCol5 = ['win5.png', 'win6.png', 'win3.png', 'win5.png', 'win6.png'];
  var startCol6 = ['win5.png', 'win6.png', 'win3.png', 'win5.png', 'win6.png'];
  ...
  var colsImg6 = Array.from(cols[5].querySelectorAll('img'));
...
var win1Col1 = ['win5.png', 'win8.png', 'win6.png', 'win5.png', 'win3.png'];
var win1Col2 = ['win8.png', 'win6.png', 'win8.png', 'win6.png', 'win3.png'];
var win1Col3 = ['win4.png', 'win8.png', 'win6.png', 'win8.png', 'win6.png'];
var win1Col4 = ['win5.png', 'win4.png', 'win5.png', 'win8.png', 'win8.png'];
var win1Col5 = ['win5.png', 'win6.png', 'win8.png', 'win6.png', 'win4.png'];
var win1Col6 = ['win3.png', 'win8.png', 'win7.png', 'win4.png', 'win8.png'];
var win2Col1 = ['win5.png', 'win8.png', 'win6.png', 'win8.png', 'win6.png'];
var win2Col2 = ['win3.png', 'win6.png', 'win8.png', 'win5.png', 'win3.png'];
var win2Col3 = ['win6.png', 'win8.png', 'win3.png', 'win8.png', 'win4.png'];
var win2Col4 = ['win6.png', 'win8.png', 'win7.png', 'win4.png', 'win6.png'];
var win2Col5 = ['win3.png', 'win6.png', 'win8.png', 'win7.png', 'win3.png'];
var win2Col6 = ['win3.png', 'win6.png', 'win7.png', 'win8.png', 'win3.png'];
var colsImg1 = Array.from(cols[0].querySelectorAll('img'));
var colsImg2 = Array.from(cols[1].querySelectorAll('img'));
var colsImg3 = Array.from(cols[2].querySelectorAll('img'));
var colsImg4 = Array.from(cols[3].querySelectorAll('img'));
...
var colsImg6Two = Array.from(cols[5].querySelectorAll('img'));
var tries = 0;
function spin() {
  //sounds
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            slotSound.play();
            _context.next = 10;
            return delaySound(700);
          case 10:
            winSlots.play();
            _context.next = 13;
            return delaySound(2700);
          case 13:
            popupSound.play();
            _context.next = 19;
            break;
...
cols.forEach(function (item) {
  var isIOS = /iPhone|iPad|iPod|Macintosh/i.test(navigator.userAgent) && 'ontouchend' in document;
  if (isIOS) {
